...
export const agentMenuOptions = (_t: (key: string) => string): MenuOption[] => [
    {
        type: 'group',
        label: '總覽',
        key: 'overview-group',
    ...
    },
    {
        ...
        children: [
            ...
            { label: renderLink('/agent/finance/invoices', '帳單與收款'), key: 'AgentInvoices', icon: renderIcon(AccountBalanceWalletOutlined) }
        ]
    },
    {
        type: 'group',
    ...
    },
    {
        ...
        key: 'developer-group',
        children: [
            { label: renderLink('/agent/developer', 'API 與白名單'), key: 'AgentDeveloperCenter', icon: renderIcon(CodeOutlined) }
        ]
    }
]
