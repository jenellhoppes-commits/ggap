...
export const merchantRoutes: RouteRecordRaw = {
    ...
    children: [
        ...
        { path: 'reports/daily', name: 'DailyReport', component: () => import('../../views/Merchant/Reports/RevenueReport.vue'), meta: { title: '每日營收' } },
        ...
        { path: 'finance/invoices', name: 'merchant-finance', component: () => import('../../views/Merchant/Finance/MyInvoices.vue'), meta: { title: '錢包 / 帳單' } },
