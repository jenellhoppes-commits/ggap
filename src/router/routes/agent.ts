...
export const agentRoutes: RouteRecordRaw = {
  ...
  children: [
    ...
    { path: 'finance/invoices', name: 'AgentInvoices', component: () => import('../../views/Merchant/Finance/MyInvoices.vue'), meta: { title: '平台帳單' } },
    ...
    { path: 'developer', name: 'AgentDeveloperCenter', component: () => import('../../views/Merchant/Developer/Index.vue'), meta: { title: '代理報表 API' } }
  ]
}
